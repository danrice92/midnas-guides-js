...
import logo from 'images/the-legend-of-zelda-logo.png';
import heroArt from 'images/the-legend-of-zelda-hero-art.jpeg';
      ...
      <Container fluid>
        <Row>
          <Col className="d-flex justify-content-center">
            <Image fluid alt="The Legend of Zelda logo" src={logo} />
          </Col>
        </Row>
        <p>
        ...
        <Row>
          <Col>
            <Card>
              <Card.Img src={heroArt} />
              <Card.Body>
                <Card.Title>Walkthrough (First Quest)</Card.Title>
              </Card.Body>
            </Card>
          </Col>
          <Col>
            <Card>
              <Card.Img src={heroArt} />
              <Card.Body>
                <Card.Title>Walkthrough (Second Quest)</Card.Title>
              </Card.Body>
            </Card>
          </Col>
          <Col>
            <Card>
              <Card.Img src={heroArt} />
              <Card.Body>
                <Card.Title>Heart Containers</Card.Title>
              </Card.Body>
            </Card>
          </Col>
          <Col>
          ...
          <Col>
            <Card>
              <Card.Img src={heroArt} />
              <Card.Body>
                <Card.Title>Secret Rupees</Card.Title>
              </Card.Body>
            </Card>
          </Col>
          <Col>
...
//       <p>
//         Controls are listed for the Nintendo Switch Online version of the game.
//       </p>
...
//               <ul>
//                 <li>
//                   <strong>Startup Menu:</strong> Move the cursor when selecting
//                   text for your character's name.
//                 </li>
//                 <li>
//                   <strong>Inventory Menu:</strong> Move the cursor to select a
//                   different item.
//                 </li>
//                 <li>
...
//                 </li>
//                 <li>
//                   <strong>Game:</strong> Pause or un-pause the game, bringing up
//                   the inventory menu.
//                 </li>
//               </ul>
//             </td>
...
//                 </li>
//                 <li>
//                   <strong>Game:</strong> Pause or un-pause the game, freezing
//                   the screen.
//                 </li>
//               </ul>
//             </td>
...
//               <ul>
//                 <li>
//                   <strong>Startup Menu:</strong> Move the cursor to the right
//                   when naming a character, cycling back to the start of the line
//                   when the far right is reached. Both buttons are equivalent to
//                   the NES's B button.
//                 </li>
//                 <li>
//                   <strong>Game:</strong> Use the item equipped in the inventory
//                   menu.
//                 </li>
//               </ul>
//             </td>
...
//         franchise. It was released in 1986 in Japan, and 1987 internationally.
//       </p>
//       <h1>It's dangerous to go alone... Here are a few things to know!</h1>
//       <ul>
//         <li className="mt-3">
//           The original release came with a detailed instruction booklet and a
//           map in the box that contained lots of valuable information for
...
//           limitations meant that very little data could be stored on one game
//           cartridge. Expect a challenge ahead!
//         </li>
//       </ul>
//       <h1>Where to Buy</h1>
//       <p>
...
//                 Nintendo Switch Online)
//               </a>
//               . Modified versions are included that allow players to start with
//               extra hearts and equipment.
//             </td>
//           </tr>
//           <tr>
//             <td>2016</td>
...
//             <td>2004</td>
//             <td>
//               GameCube (part of <i>The Legend of Zelda: Collector's Edition</i>,
//               a compilation of classic games in the series)
//             </td>
//           </tr>
//           <tr>
//             <td>2001</td>
...
// - About
// - Controls
// - Walkthrough (first quest)
// - Walkthrough (second quest)
// - Heart Containers
// - Rupees
// - Items
